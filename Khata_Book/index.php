  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="index.php" class="list-group-item list-group-item-action bg-active "><span
        ...
        <a href="manage_expense.php" class="list-group-item list-group-item-action bg-warning "><span
          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="index.php"><?php echo $firstname . " " . $lastname ?></a>
